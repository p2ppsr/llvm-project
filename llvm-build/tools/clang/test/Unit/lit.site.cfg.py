# Autogenerated from /Users/tyeverett/projects/llvm-project/clang/test/Unit/lit.site.cfg.py.in
# Do not edit!
...
lit_config.load_config(
    config, os.path.join(path(r"/Users/tyeverett/projects/llvm-project/clang"), "test/Unit/lit.cfg.py"))
