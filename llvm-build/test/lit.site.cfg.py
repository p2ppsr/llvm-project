# Autogenerated from /Users/tyeverett/projects/llvm-project/llvm/test/lit.site.cfg.py.in
# Do not edit!
...
config.osx_sysroot = path(r"/Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX14.5.sdk")
config.ocamlfind_executable = "OCAMLFIND-NOTFOUND"
config.have_ocamlopt = 0
config.ocaml_flags = ""
config.ptxas_executable = ""
config.enable_assertions = 0
config.targets_to_build = " X86 Everett"
...
config.llvm_dylib_version = "20.0git"
config.llvm_host_triple = 'arm64-apple-darwin23.4.0'
